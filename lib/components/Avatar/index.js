  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        {(typeof source === 'string' || typeof source === 'object') && source ? (
          ...
          <View style={[styles.noAvatar, sizeStyle, { backgroundColor: noAvatarBackgroundColor }]}>
            <Text style={[styles.letter, letterSizeStyle, { color: letterColor }]}>
              {letter[0]}
            </Text>
          </View>
        )}
